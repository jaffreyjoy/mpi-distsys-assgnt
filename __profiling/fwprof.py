...
def profile_execution(n):
    # Compile the code
    compile_command = "mpic++ mpifw.cpp -o mpifw"
    ...
    # Run the code
    run_command = f"mpirun -n {n} --use-hwthread-cpus --oversubscribe ./mpifw < fw.inp > fw.outp"
...
def main():
    ...
    image_filename = "mpi_fw_execution_time_plot.png"
