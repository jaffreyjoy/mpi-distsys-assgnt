...
def profile_execution(n):
    # Compile the code
    compile_command = "mpic++ mpifwcfb.cpp -o mpifwcfb"
    ...
    # Run the code
    run_command = f"mpirun -n {n} --use-hwthread-cpus --oversubscribe ./mpifwcfb < fw.inp > fw.outp"
...
def main():
    ...
    image_filename = "mpi_fwcfb_execution_time_plot.png"
